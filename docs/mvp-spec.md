...
Вам предстоит реализовать следующий функционал: выбор сложности и упрощенного режима игры, основную логику игры, вывод результата. Ниже вы найдёте подробное описание каждого пункта.
...
Как только уровень сложности выбран, игроку показывается игровой поле.
...
Счетчик ошибок представлен в виде строки "Счетчик ошибок: n ", где n увеличивается на единицу после каждой ошибки совершенной игроком. После третьей ошибки появляетя окно завершения игры.
